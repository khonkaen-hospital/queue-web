...
export class PrioritiesServicepointService {
  ...
  async listBySerivicePoint(id) {
    const _url = `${this.apiUrl}/priorities-servicepoint/servicepoint/` + id;
    return this.httpClient.get(_url, this.httpOptions).toPromise();
  }

  async save(data: object) {
    const _url = `${this.apiUrl}/priorities-servicepoint`;
    return this.httpClient.post(_url, data, this.httpOptions).toPromise();
  }

  async update(servicePointId: any, data: object) {
    const _url = `${this.apiUrl}/priorities-servicepoint/${servicePointId}`;
